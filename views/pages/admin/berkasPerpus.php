      ...
      <div class="container">
        <div class="page-inner">
          <div
            ...
            <div>
              <h2 class="fw-bold mb-3">Berkas Perpustakaan</h2>
            ...
            <div class="card card-round">
              <div class="card-header">
                <div class="card-head-row card-tools-still-right">
                  <div class="card-title">Berikut berkas tanggungan perpustakaan yang harus diverifikasi</div>
                      ...
                      <tbody>
                        <!-- Projects table -->
                          <tr>
                            ...
                            <td>Perpustakaan</td>
                            <td>Surat Bebas Tanggungan Perpustakaan</td>
                            <td>
